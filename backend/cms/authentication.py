...
class TNEmisAuth(BaseAuthentication):
    """
    ...
    def _alphabet_to_number(self, string):
        mapping = {
            'A': '0', 'b': '1', 'C': '2', 'd': '3', 'E': '4',
            'f': '5', 'G': '6', 'h': '7', 'I': '8', 'j': '9',
        }
    ...
    def _validate_key(self, key):
        ...
        try:
            ts = int(self._alphabet_to_number(middle)) / 1000
    ...
    def authenticate(self, request):
        ...
        if settings.DEBUG and api_key == 'dev':
            ...
            return (self._sync_user(decoded), None)
        # ─────────────────────────────────────────────────────────────────────
        ...
        if not token:
            ...
            transformed = self._assign_letters(token)
            decoded = jwt.decode(
                transformed,
    ...
    def _sync_user(self, token_details):
        """
