...
class Meeting(models.Model):
    ...
    pair = models.ForeignKey(UnitPair, on_delete=models.CASCADE, related_name='meetings')
    ...
    notify_units = models.ManyToManyField(ConvergenceUnit, blank=True, related_name='notified_meetings')
