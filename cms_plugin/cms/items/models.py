...
class Item(models.Model):
    ...
    raiser = models.ForeignKey(ConvergenceUnit, on_delete=models.CASCADE, related_name='raised_items')
    targets = models.ManyToManyField(ConvergenceUnit, related_name='received_items')
